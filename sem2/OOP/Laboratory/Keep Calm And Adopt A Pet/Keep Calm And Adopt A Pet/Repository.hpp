...
public:
    ...
    int findPosByBreedAndName(const std::string& breed, const std::string& name);
    
    void deleteDog(const Dog& d);
    
    void updateDog(const Dog& d1, const Dog& d2);
    
    //modif
    void setDogOnPos(int pos, const Dog& d);
    void sortAscendingByBreed();
