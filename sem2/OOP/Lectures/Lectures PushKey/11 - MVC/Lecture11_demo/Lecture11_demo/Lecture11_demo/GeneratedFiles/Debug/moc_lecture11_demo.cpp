...
QT_MOC_LITERAL(1, 15, 11), // "genesWidget"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 9) // "genesView"

    },
    "Lecture11_demo\0genesWidget\0\0genesView"
};
...
void Lecture11_demo::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Lecture11_demo *_t = static_cast<Lecture11_demo *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->genesWidget(); break;
        case 1: _t->genesView(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Lecture11_demo::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Lecture11_demo.data,
      qt_meta_data_Lecture11_demo,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Lecture11_demo::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Lecture11_demo.stringdata0))
        return static_cast<void*>(const_cast< Lecture11_demo*>(this));
