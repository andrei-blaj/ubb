	...
	: QMainWindow(parent)
{
	...
	// initialize castles
	this->castles.push_back(Castle{ "Highclere Castle", "England", 4 });
	this->castles.push_back(Castle{ "Chambord Castle", "France", 3 });
	this->castles.push_back(Castle{ "Scaliger Castle", "Italy", 2 });
	this->castles.push_back(Castle{ "Windsor Castle", "England", 6 });
