...
use the compare interrupt to set the value of 
OCR0 to generate different tones
 */
...
ISR(TIMER0_COMPA_vect)
{
    ...
    counter++;
    if (counter==0) OCR0A--;
    //when we counted 255 times already from 0x00 to OCR0A 
    //then change the OCRA value
...
int main()
{
  ...
  TIMSK0 = 0b00000010; //we have an interrupt the compare A interrupt
