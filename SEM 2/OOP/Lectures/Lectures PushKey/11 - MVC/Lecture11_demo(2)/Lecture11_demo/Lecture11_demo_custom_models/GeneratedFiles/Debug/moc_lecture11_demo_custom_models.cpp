...
const QMetaObject Lecture11_demo_custom_models::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Lecture11_demo_custom_models.data,
      qt_meta_data_Lecture11_demo_custom_models,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Lecture11_demo_custom_models::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Lecture11_demo_custom_models.stringdata0))
        return static_cast<void*>(const_cast< Lecture11_demo_custom_models*>(this));
